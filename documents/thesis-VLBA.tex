%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Template of the department Very Large Business Applications (VLBA),
%% CvO University Oldenburg for scientific papers.
%%
%% Versions, dates and authors:
%%		version 1 (16.04.2010) by Dipl.-Inform. Daniel Süpke
%%
%% Note: 
...
\begin{titlepage}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=310pt]{UOL-Logo}    % Ggf. Copyright beachten - ansonsten nur für Gebrauch an der CvO
  \end{figure}
  ...
  \begin{figure}[h!]
    \centering
    \includegraphics[width=250pt]{VLBA-Logo}    % Ggf. Copyright beachten - ansonsten nur für Gebrauch an der CvO/VLBA
  \end{figure}
